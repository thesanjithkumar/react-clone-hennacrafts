...
function TermsAndCondition() {
  return (
    <div className={classes.border}>
      ...
      <p>Welcome to Nayab Organic Henna!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Natural Mehandi Powder Udhyog’s Website, located at hennacrafts.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Nayab Organic Henna if you do not
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By accessing Nayab Organic Henna, you
        agreed to use cookies in agreement with the Natural Mehandi Powder
        Udhyog’s Privacy Policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, Natural Mehandi Powder Udhyog and/or its
        licensors own the intellectual property rights for all material on Nayab
        Organic Henna. All intellectual property rights are reserved. You may
        access this from Nayab Organic Henna for your own personal use subjected
        to restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul className={classes.bullets}>
        <li>Republish material from Nayab Organic Henna</li>
        <li>Sell, rent or sub-license material from Nayab Organic Henna</li>
        <li>Reproduce, duplicate or copy material from Nayab Organic Henna</li>
        <li>Redistribute content from Nayab Organic Henna</li>
      </ul>
      <p>
        ...
        Privacy <div className={classes.lastchild}>Policy Generator.</div>
      </p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Natural Mehandi Powder Udhyog does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of NaTermsAndCondition
      </p>
      <p>
        Natural Mehandi Powder Udhyog reserves the right to monitor all Comments
      ...
      <p>
        You hereby grant Natural Mehandi Powder Udhyog a non-exclusive license
      ...
      <p>
        ...
        the hyperlink compensates the absence of Natural Mehandi Powder Udhyog;
      ...
      <p>
        ...
        e-mail to Natural Mehandi Powder Udhyog. Please include your name, your
      ...
      <p>
        No use of Natural Mehandi Powder Udhyog’s logo or other artwork will be
      ...
      <p>
        We reserve the right to requestTermsAndCondition that you remove all
        links or any particular link to our Website. You approve to immediately
        remove all links to our Website upon request. We also reserve the right
        to amen these terms and conditions and it’s linking policy at any time.
