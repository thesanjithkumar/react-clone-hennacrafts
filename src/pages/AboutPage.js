    ...
    <div className={classes.container}>
      ...
      <div className={classes.border}>
        <div className={classes.contents}>
          ...
          <p>Tuas quisquam quo gravida proident harum, aptent ligula anim consequuntur, ultrices mauris, nunc
            voluptates lobortis, varius, potentiplaceat! Fuga omnis. Cubilia congue. Recusandae. Vero penatibus quasi! Nostra tenetur dignissimos
             ultrices natus distinctio ultri consequuntur numqu.</p>
          </div>
      ...
      <div className={classes.aboutpagedownpart}>
           <div className={classes.imageborder}>
              <div className={classes.outerbox}>
                ...
                <img src="https://hennacrafts.com/wp-content/uploads/elementor/thumbs/t3-ozdlcxn9osb2dbychcb6wjjjrwy2ab1xtau9paa2a0.jpg" alt="" />
               
               <img src="https://hennacrafts.com/wp-content/uploads/elementor/thumbs/t2-ozdlcmd7ervmi0eqb7fo2me0nahnpxt5rr0fxyqsco.jpg" alt="" />
          
               <img src="https://hennacrafts.com/wp-content/uploads/elementor/thumbs/t1-ozdlcjjou9rrj6itro7sd53mv4vk2uhyrd1zi4uyvc.jpg" alt="" />
             
               <img src="https://hennacrafts.com/wp-content/uploads/elementor/thumbs/indigo-3-pack-with-kit-ozdlbivzfqdkye02pqdc5wcnp3w8qngfmbm1scdbm0.jpg" alt="" />
             
               <img src="https://hennacrafts.com/wp-content/uploads/elementor/thumbs/indigo-with-kit-ozdlbd8yaq5v0q89mnxkqxrw4so1ggu1ljp4wolonc.jpg" alt="" />
                </div>
              </div>
              ...
              <img className={classes.dummyimage} src="https://hennacrafts.com/wp-content/uploads/2021/04/cropped-nayab-henna-logo-300x100.jpg" alt="Logo" />
               </div>
           </div>
           <div className={classes.detailsborder}>
             <div className={classes.detailstoppart}>
           <img className={classes.detailsimage} src="https://hennacrafts.com/wp-content/uploads/2020/11/organic-badge-freeimg-1.png" alt="" />
           <div className={classes.textconatainer}>
           <h2 className={classes.products}>Certified Products</h2>
           <p className={classes.detailsfirstpara}>Click edit button to change this text. Lorem ipsum <br/>
           dolor sit amet</p>
           </div>
           </div>
