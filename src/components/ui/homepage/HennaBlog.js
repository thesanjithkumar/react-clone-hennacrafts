    ...
    <div className={classes.hennablog_main}>
      <div className={classes.hennablogchild} id={styles["blog"]}>
        ...
        <p className={classes.bloginnerdiv}>
          The Best Of The Best Bridal Foot Mehendi For Your Inspiration My last
          post got me thinking, we all have seen amazing bridal mehendi designs
          for our hands, but what about our feet? Every bride who applies henna
          for her wedding ceremony does apply henna on her feet too, and
        </p>
      ...
      <div className={classes.hennablogchild} id={styles["blog"]}>
        ...
        <p className={classes.bloginnerdiv}>
          ...
          21, 2019 on Hair, Hair Growth Tea tree oil has been used from several
          years but has now started becoming popular. It has been first
          introduced in Austria. the people of Australia started using tea tree
          oil as antiseptic. Tea tree oil
        </p>
        <div className={classes.blogbuttondiv}>
          <a href="/blog" className={classes.blogbutton}>
            Read More
