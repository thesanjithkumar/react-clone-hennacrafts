  ...
  return <footer className={classes.footer}>
    <div className={classes.main}>
      <div className={classes.about}>
        <h2>About us</h2>
        <p>Mr. Suraj Mal Parihar started
          our business in 1980 as a Mehandi Powder
          Udyog at Sojat City, the only wholesale
          marketof henna in India.
        </p>
      </div>
      ...
      <div className={classes.nav}>
        ...
        <ul>
          ...
          <li><Link to='/' className={classes.link}>FAQ</Link></li>
        </ul>
      </div>
    </div>
    <div className={classes.media}>
       <div className={classes.copyright}>Copyright &copy; 2021 | HennaCrafts</div>
       <div className={classes.socialmedia}>
         <Link to='/'><FaFacebookF className={classes.facebook}/></Link>
         <Link to='/'><FaInstagram className={classes.instagram}/></Link>
       </div>
    </div>
  </footer>;
}
